...
**Note:** GCP cost data requires BigQuery billing export. Without `bigQueryDataset` in credentials, Costdoq will show $0. Enable Billing Export to BigQuery in GCP Console and add the dataset path.

...
import { UserPlus, Mail, Lock, Eye, EyeOff, User, Cloud, Zap, TrendingUp, BarChart3, Shield, Brain, DollarSign, CheckCircle2 } from 'lucide-react'
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16 lg:px-16 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          {/* Title */}
          <div className="mb-10">
            <h1 className="text-3xl font-bold text-[#0F172A] mb-3">Create your Account</h1>
            <p className="text-gray-600 text-base">Welcome! Select method to sign up:</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 mb-2.5">
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            ...
            <Link to="/login" className="text-[#1F3A5F] hover:text-[#243b53] font-medium">
              Sign in
            </Link>
          </p>
        </div>

    ...
    <section className="py-8 md:py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-8">
        <div className="text-center">
          <h2 className="mx-auto mb-2 text-pretty text-2xl font-semibold text-gray-900 md:text-3xl lg:max-w-3xl">
            {heading}
          </h2>
          <p className="mx-auto max-w-2xl text-gray-500 text-sm md:text-base mt-1">
            {description}
          </p>
        </div>
              ...
              <div className="grid gap-y-6 sm:grid-cols-10 sm:gap-x-5 sm:gap-y-0 md:items-center md:gap-x-8 lg:gap-x-12">
                <div className="sm:col-span-5">
                  <div className="mb-4 md:mb-6">
                    <div className="flex flex-wrap gap-3 text-xs uppercase tracking-wider text-gray-500 md:gap-5 lg:gap-6">
                  ...
                  <div className="mt-6 flex items-center space-x-2 md:mt-8">
                    <Link
                      to={post.url}
                      className="inline-flex items-center font-semibold text-primary-600 hover:underline md:text-base"
                    >
                      <span>Read more</span>

import { Copy, Check, ExternalLink, FileText, Shield, Key, Zap, Database, DollarSign } from 'lucide-react'
...
export default function IAMPolicyDialog({ isOpen, onClose, providerId, providerName }: IAMPolicyDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-4xl !rounded-2xl p-0 gap-0 sm:max-h-[90vh] flex flex-col">
        ...
        <DialogFooter className="border-t border-surface-200 px-6 py-4">
